...
func refreshKeyInTokenManager(sec *corev1.Secret, scaled *config.Scaled) error {
	...
	jwtEncryption, err := encrypter.EncryptWithAuthData([]byte(`{}`), getAdd())
	if err != nil {
